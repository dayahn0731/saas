    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center py-10">
                <div className="rounded w-5/6 shadow p-6 relative bg-white dark:bg-gray-800">
                    <div className="sm:flex items-start">
                        ...
                        <div className="ml-4">
                            <div className="py-2 px-4 sm:top-8 top-12 absolute right-0 bg-green-100 flex items-center justify-center rounded-tl-3xl rounded-bl-3xl">
                                <a className="text-xs font-semibold text-center text-green-700" href={props.link}>Link to Project</a>
                            </div>
                            {props.removeable ? <div className="py-2 px-4 sm:top-20 top-20 absolute right-0 bg-red-100 flex items-center justify-center rounded-tl-3xl rounded-bl-3xl">
                                <p className="text-xs font-semibold text-center text-red-700" onClick={props.onProjectRemoved}>Remove</p>
                            </div> : <></>}
                            <div className="sm:pt-0 pt-4">
                                <p className="text-xl font-semibold leading-5 pt-1 text-gray-800 dark:text-gray-100">{props.name}</p>
                                <p className="text-sm leading-4 pt-2 text-gray-500 dark:text-gray-400">
                                    <span className="text-indigo-700 font-semibold">{props.startDate} - {props.endDate}</span>
                                </p>
                            </div>
                            <div className="mt-2">
                                <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">{props.description}</p>
                                <div className="sm:flex items-center mt-4">
                                    <div className="flex items-center sm:mt-0 mt-4">
                                        ...
                                        <p className="text-sm leading-4 text-gray-500 ml-2 dark:text-gray-400">{props.skills}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
