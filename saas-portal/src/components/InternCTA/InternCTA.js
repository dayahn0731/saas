    ...
    return (
        ...
        <div className="flex items-center justify-between w-full h-full">
            <div className="flex flex-col lg:flex-row w-full h-full items-start lg:items-center rounded bg-white shadow">
                <div className="w-full lg:w-7/12 h-full dark:bg-gray-800">
                ...
                <div className="w-full lg:w-5/12 h-full dark:border-gray-700 lg:h-full border-t lg:border-t-0 lg:border-r lg:border-l lg:rounded-r dark:bg-gray-700 bg-white">
                        ...
                        <div className="w-full">
                            <div className="pt-12 w-full justify-between flex">
                                <div className="flex flex-col items-center pt-2 sm:pt-8 lg:pt-2 pr-2 lg:pr-0">
                                    <div className="mt-8">
                                        <h1 className="font-bold text-indigo-900 text-lg">Sign up</h1>
                                    ...
                                    <div className="pt-8 sm:pt-16 mt-10 lg:pt-8">
                                        <h1 className="font-bold text-indigo-900 text-lg">Find a match!</h1>
                                ...
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width={119} height={385} viewBox="0 0 119 385" fill="none">
                                        <circle cx={4} cy={74} r={4} fill="#EDF2F7" />
                                        <circle cx={115} cy={143} r={4} fill="#EDF2F7" />
                                        <circle cx={7} cy={240} r={4} fill="#EDF2F7" />
                                        <circle cx={114} cy={310} r={4} fill="#EDF2F7" />
                                        <rect x={59} width={2} height={385} fill="#EDF2F7" />
                                        <rect x={4} y={73} width={55} height={2} fill="#EDF2F7" />
                                        <rect x={60} y={143} width={55} height={2} fill="#EDF2F7" />
                                        <rect x={4} y={239} width={55} height={2} fill="#EDF2F7" />
                                        <rect x={60} y={309} width={55} height={2} fill="#EDF2F7" />
                                    </svg>
                                </div>
                                <div className="flex flex-col items-center pt-10 sm:pt-28 lg:pt-14 pl-2 lg:pl-7">
                                    <div className="mt-10">
                                        <h1 className="font-bold text-indigo-900 text-lg">Get Slingshot verified</h1>
                                    ...
                                    <div className="pt-10 mt-10 lg:pt-11">
                                        <h1 className="font-bold text-indigo-900 text-lg">Slingshot ahead</h1>
