                        ...
                        <div className="flex flex-col lg:w-8/12 md:w-8/12 px-4 lg:px-0 justify-center">
                            ...
                            <div className="mt-12 flex flex-wrap">
                                <div className="mr-6 mt-5 sm:mt-0 md:mt-5 lg:mt-0">
                                    <a href="https://slingshotmentoring.typeform.com/to/WGNBeJRv"><button className="focus:outline-none bg-yellow-500 transition duration-150 ease-in-out hover:bg-yellow-400 rounded text-white w-60 py-4 text-xl">Get Started</button></a>
                                </div>
                                <div className="mt-5 sm:mt-0 md:mt-5 lg:mt-0">
                                    <a href={routes.DISCORD_INVITE_LINK}><button className="focus:outline-none bg-white transition duration-150 ease-in-out hover:bg-gray-200 rounded border border-yellow-600 text-yellow-600 w-60 py-4 text-xl">Join our Discord</button></a>
                                </div>
                            </div>
                        </div>
