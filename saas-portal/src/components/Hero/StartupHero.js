                        ...
                        <div className="flex flex-col lg:w-10/12 md:w-10/12 px-4 lg:px-0 justify-center">
                            ...
                            <div className="mt-12 flex flex-wrap">
                                <div className="mr-6 mt-5 sm:mt-0 md:mt-5 lg:mt-0 w-6/12">
                                    <button className="focus:outline-none bg-yellow-500 transition duration-150 ease-in-out hover:bg-yellow-400 rounded text-white px-14 py-4 text-xl w-8/12"><a href="https://slingshotmentoring.typeform.com/to/WGNBeJRv">Get started</a></button>
                                </div>
                            </div>
                        </div>
