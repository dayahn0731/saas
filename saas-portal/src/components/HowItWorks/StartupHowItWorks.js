...
function StartupHowItWorks() {
    return (
        <>
            <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
                <h1 className="text-center text-3xl lg:text-5xl tracking-wider text-gray-900">How it works?</h1>
                    ...
                    <div className="hidden md:flex justify-center w-full">
                        <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
                            ...
                            <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
                                ...
                                <h2 className="text-gray-700 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                            </div>
                        ...
                        <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
                            ...
                            <div className="flex mt-12 flex-col items-center md:items-start md:w-8/12">
                                ...
                                <h2 className="text-gray-700 mt-3 text-base leading-6 tracking-wide">Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                            </div>
...
export default StartupHowItWorks;