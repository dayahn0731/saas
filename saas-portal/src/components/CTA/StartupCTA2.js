                    ...
                    <div className="text-center md:flex flex-col items-center">
                        ...
                        <div className="flex justify-center flex-wrap">
                            <div className="m-6 py-8">
                                <a href="https://slingshotmentoring.typeform.com/to/WGNBeJRv"><button className="focus:outline-none bg-yellow-500 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-4 py-2 text-base  md:px-8 md:py-4 md:text-xl">Start hiring today</button></a>
                            </div>
                        </div>
                    </div>
                </div>
