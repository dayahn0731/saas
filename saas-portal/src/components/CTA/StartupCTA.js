            ...
            <div className="relative py-16 px-4 bg-black">
                <div className="w-full lg:flex-row flex flex-col-reverse items-center justify-between mx-auto container relative xl:px-0 px-4">
                    ...
                    <div className="lg:w-1/2 lg:pl-40 xl:pl-56">
                        <h1 className="lg:text-5xl text-3xl f-m-w text-indigo-700 font-bold">High schoolers as engineers?</h1>
                        <p className="lg:text-base text-sm f-m-m leading-loose mt-3 mb-8 text-white">We know what you're thinking. But, the average of coding is exponentially decreasing by the day and a large portion of these programmers are going unnoticed simply due to age bias and/or lack of credentials. Slingshot interns regularly challenge the status quo and are in a lot of cases as good or better than entry-level engineers. High schoolers of today are more precocious, skilled and smarter than ever. The world's changing; we recognize it -- and it's time for you to hop on as well.</p>
